...
const static uint8_t inDgPins[QT_IN_DG]={33, 31, 29, 27, 25, 28};
const static uint8_t inAlPins[QT_IN_AL]={A0, A1, A2, A3, A4, A5};
const static uint8_t outDgPins[QT_OUT_DG]={32, 37, 39, 41, 43, 45};
